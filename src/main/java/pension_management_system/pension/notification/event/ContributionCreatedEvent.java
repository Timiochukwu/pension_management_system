...
/**
 * ContributionCreatedEvent - Event fired when contribution is created
 *
 * Purpose: Trigger email notification when contribution recorded
 */
@Getter
public class ContributionCreatedEvent extends ApplicationEvent {
    ...
    public ContributionCreatedEvent(
            Object source,
            Long contributionId,
            Long memberId,
            String memberName,
